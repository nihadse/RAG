...
def generate_mermaid_diagram(ai_agents: List[AIAgentStep], connections: List[WorkflowConnection]) -> str:
    ...
    for i, agent in enumerate(ai_agents):
        ...
        if agent.ai_capabilities:
            for j, capability in enumerate(agent.ai_capabilities[:3]):  # Limit to 3 for readability
...
WORKFLOW_FILE = "sample_workflow.yxmd"  # Replace with your workflow file path
OUTPUT_DIR = "./analysis_output"

# Uncomment and run the following code to analyze a workflow:

"""
# Step 1: Create a sample workflow if you don't have one
...
print("\nTo run the analysis:")
print("1. Set your OPENAI_API_KEY above")
print("2. Uncomment and run the code in this cell")
print("3. Or call: analyze_workflow('your_file.yxmd', 'your-api-key')")
